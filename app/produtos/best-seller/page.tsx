...
export default function BestSellerPage() {
  // Simulando produtos mais vendidos (primeiros 8 produtos)
  const produtosBestSeller = produtos.slice(0, 8)

  const [mobileFiltersOpen, setMobileFiltersOpen] = useState(false)
  const [produtosFiltrados, setProdutosFiltrados] = useState(produtosBestSeller)
  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="relative h-[40vh] w-full">
        <Image
          src="/placeholder.svg?height=600&width=1600&text=Best Sellers"
          alt="Best Sellers CYGA"
          fill
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white p-4">
          <h1 className="text-4xl md:text-6xl font-light mb-4">BEST SELLERS</h1>
          <p className="text-xl md:text-2xl font-light max-w-2xl">Nossas peças mais amadas</p>
        </div>
      </section>
